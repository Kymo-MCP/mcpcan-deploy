...
export NAMESPACE=mcp-dev
export GlobalCN=true
export GlobalDomain=mcp-dev.itqm.com
export GlobalHostStorageRootPath=/data/mcp-dev
export GlobalHostStorageStaticPath=/data/mcp-dev/static
export GlobalHostStorageCodePackagePath=/data/mcp-dev/code-package
export GlobalHostStorageMysqlPath=/data/mcp-dev/mysql
export GlobalHostStorageRedisPath=/data/mcp-dev/redis
