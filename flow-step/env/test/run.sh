...
TLS_CERT_PATH="$PROJECT_ROOT/flow-step/env/test/tls.cert"
TLS_KEY_PATH="$PROJECT_ROOT/flow-step/env/test/tls.key"

export NAMESPACE=mcp-test
export GlobalCN=true
export GlobalDomain=mcp-test.itqm.com
export GlobalHostStorageRootPath=/data/mcp-test
export GlobalHostStorageStaticPath=/data/mcp-test/static
export GlobalHostStorageCodePackagePath=/data/mcp-test/code-package
export GlobalHostStorageMysqlPath=/data/mcp-test/mysql
export GlobalHostStorageRedisPath=/data/mcp-test/redis
export InfrastruscureMysqlServiceNodePort=32306
export InfrastruscureRedisServiceNodePort=32379
